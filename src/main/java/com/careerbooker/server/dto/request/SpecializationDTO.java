...
public class SpecializationDTO {
    ...
    @NotBlank(message = "Specialization name required", groups = {  InsertValidation.class, UpdateValidation.class })
    private String name;
    ...
    private SpecializationSearchDTO specializationSearchDTO;
}
